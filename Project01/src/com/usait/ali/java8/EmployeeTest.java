package com.usait.ali.java8;

import java.util.*;
import java.util.stream.Collectors;

import com.usait.ali.java8.Employee;
...
public class EmployeeTest {
	...
	System.out.println("The total number of Male and Female "+noofMaleandFemale);
	...
	Optional<Employee> maxsalaryWrapper=employeeList.stream().collect(Collectors.maxBy(Comparator.comparingDouble(Employee :: getSalary)));
